...
const KeyStoreScheme25519 = "key25519"
...
// NewAccount25519 generates a new key and stores it into the key directory,
// encrypting it with the passphrase.
func (ks *KeyStore) NewAccount25519(passphrase string) (accounts.Account, error) {
	_, account, err := storeNewKey(ks.storage, crand.Reader, passphrase, "ed25519")
	if err != nil {
		return accounts.Account{}, err
	}
	// Add the account to the cache immediately rather
