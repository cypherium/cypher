...
import (
	...
	"github.com/cypherium/cypher/eth/fetcher"
...
func (pm *ProtocolManager) Start(maxPeers int) {
	...
	log.Info("handle.Start", "maxPeers", maxPeers)
...
func (pm *ProtocolManager) handleMsg(p *peer) error {
	...
	if err != nil {
		log.Debug("handleMsg", "error", err)
		return err
	}
	if msg.Size > protocolMaxMsgSize {
		//log.Info("handleMsg.error")
