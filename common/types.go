...
func (a PublicKey25519) Hex() string {
	/*
		s := make([]byte, len(a)*2)
		for i, tn := range a {
			s[i*2], s[i*2+1] = hexDigit[tn>>4], hexDigit[tn&0xf]
...
func (a PublicKey25519) String() string { return a.Hex() }
func (a PublicKey25519) Bytes() []byte  { return a[:] }
func (a *PublicKey25519) SetBytes(b []byte) {
	if len(b) > len(a) {
		b = b[len(b)-PublicKey25519Length:]
	}
...
func (a *Address) ToPublicKey25519() PublicKey25519 {
	var b PublicKey25519
	b.SetBytes(a[:])
	return b
}
