...
var (
	...
	retestethCommand = cli.Command{
		...
		Name:        "retesteth",
		Usage:       "Launches cypher in retesteth mode",
		ArgsUsage:   "",
		Flags:       []cli.Flag{rpcPortFlag},
		Category:    "MISCELLANEOUS COMMANDS",
		Description: `Launches cypher in retesteth mode (no database, no network, only retesteth RPC interface)`,
	}
)
...
func (e *NoRewardEngine) PowMode() uint {
	return uint(0)
}
