...
import (
	...
	//	"github.com/cypherium/cypher/accounts/external"
...
func (c *Config) ResolvePath(path string) string {
	...
	if warn, isOld := isOldGethResource[path]; isOld {
		...
		if oldpath != "" && common.FileExist(oldpath) {
			if warn {
				c.warnOnce(&c.oldGethResourceWarning, "Using deprecated resource file %s, please move this file to the 'cypher' subdirectory of datadir.", oldpath)
			}
			return oldpath
		}
	}
