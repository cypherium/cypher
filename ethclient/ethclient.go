...
func (ec *Client) SyncProgress(ctx context.Context) (*cypher.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (cypher.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q cypher.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q cypher.FilterQuery, ch chan<- types.Log) (cypher.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q cypher.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg cypher.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg cypher.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg cypher.CallMsg) (uint64, error) {
...
func toCallArg(msg cypher.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
