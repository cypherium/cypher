...
web3._extend({
       ...
       [
		new web3._extend.Method({
			name: 'members',
			call: 'reconfig_members',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
        new web3._extend.Method({
			name: 'exceptions',
			call: 'reconfig_exceptions',
			params: 1,
			inputFormatter: [web3._extend.formatters.inputBlockNumberFormatter]
		}),
      new web3._extend.Method({
			name: 'takePartInBlocks',
			call: 'reconfig_takePartInBlocks',
			params: 2,
			inputFormatter: [web3._extend.formatters.inputAddressFormatter,null]
		}),
       ],
       ...
       [
               ...
               new web3._extend.Property({
                       name: 'leader',
                       getter: 'reconfig_leader'
               }),
               new web3._extend.Property({
					   name: 'role',
				       getter: 'reconfig_role'
			   }),
			   new web3._extend.Property({
					   name: 'roleList',
					   getter: 'reconfig_roleList'
               }),
       ]
})
`
